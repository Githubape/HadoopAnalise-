 ...
 * @Version 1.0.0
 */
public class Topic_ClassDriver {
     /*
    Map处理
    分割及映射数据
     */

    public static class Topic_ClassMapper extends Mapper<LongWritable, Text,Text, IntWritable>
    {
        @Override
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            //获得性别
            String payType= fields[fields.length-11]+" "+fields[fields.length-1];
    ...
    汇总数据
     */
    public static class Topic_ClassReduce extends Reducer<Text,IntWritable,Text,IntWritable>
    {
        @Override
    ...
    public void run(String in,String out) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        //指定jar包
        job.setJarByClass(Topic_ClassDriver.class);
        //指定Mapper Reducer业务处理类
        job.setMapperClass(Topic_ClassMapper.class);
        job.setReducerClass(Topic_ClassReduce.class);
        //指定map输出类型
