 ...
 * @Version 1.0.0
 */
public class SexAnalyse {
     /*
    Map处理
    分割及映射数据
     */

    public static class SexAnalyseMapper extends Mapper<LongWritable, Text,Text, IntWritable>
    {
        @Override
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            //获得性别
            String payType= fields[fields.length-17];
            //输出数据
    ...
    汇总数据
     */
    public static class SexAnalyseReduce extends Reducer<Text,IntWritable,Text,IntWritable>
    {
        @Override
    ...
    public void run(String in,String out) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        //指定jar包
        job.setJarByClass(SexAnalyse.class);
        //指定Mapper Reducer业务处理类
        job.setMapperClass(SexAnalyse.SexAnalyseMapper.class);
        job.setReducerClass(SexAnalyse.SexAnalyseReduce.class);
        //指定map输出类型
