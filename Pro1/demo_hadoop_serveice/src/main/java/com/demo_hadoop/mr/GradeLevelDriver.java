 ...
 * @Version 1.0.0
 */
public class GradeLevelDriver {
     /*
    Map处理
    分割及映射数据
     */

    public static class GradeLevelMapper extends Mapper<LongWritable, Text,Text, IntWritable>
    {
        @Override
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            //获得性别
            String payType= fields[fields.length-13];
            //输出数据
    ...
    汇总数据
     */
    public static class GradeLevelReduce extends Reducer<Text,IntWritable,Text,IntWritable>
    {
        @Override
    ...
    public void run(String in,String out) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        //指定jar包
        job.setJarByClass(GradeLevelDriver.class);
        //指定Mapper Reducer业务处理类
        job.setMapperClass(GradeLevelMapper.class);
        job.setReducerClass(GradeLevelReduce.class);
        //指定map输出类型
