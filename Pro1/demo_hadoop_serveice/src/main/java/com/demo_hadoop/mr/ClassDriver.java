...
public class ClassDriver {
    ...
    public static class ClasssMapper extends Mapper<LongWritable, Text,Text, IntWritable>
    {
        @Override
    ...
    汇总数据
     */
    public static class ClassReduce extends Reducer<Text,IntWritable,Text,IntWritable>
    {
        @Override
    ...
    public void run(String in,String out) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setMapperClass(ClasssMapper.class);
