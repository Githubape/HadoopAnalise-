 ...
 * @Version 1.0.0
 */
public class HandRaiseDriver {
     /*
    Map处理
    分割及映射数据
     */

    public static class HandRaiseMapper extends Mapper<LongWritable, Text,Text, IntWritable>
    {
        @Override
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            //获得性别
            String payType= fields[fields.length-8];
            System.out.println("Handraise "+payType);
            //输出数据
    ...
    汇总数据
     */
    public static class HandRaiseReduce extends Reducer<Text,IntWritable,Text,IntWritable>
    {
        @Override
    ...
    public void run(String in,String out) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        //指定jar包
        job.setJarByClass(HandRaiseDriver.class);
        //指定Mapper Reducer业务处理类
        job.setMapperClass(HandRaiseMapper.class);
        job.setReducerClass(HandRaiseReduce.class);
        //指定map输出类型
