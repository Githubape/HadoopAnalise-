...
public class StudentAbsence {
    ...
    public static class StudentAbsenceMapper extends Mapper<LongWritable, Text,Text, IntWritable>
    {
        @Override
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            //获得性别
            String payType= fields[fields.length-2];
            //输出数据
    ...
    汇总数据
     */
    public static class StudentAbsenceReduce extends Reducer<Text,IntWritable,Text,IntWritable>
    {
        @Override
    ...
    public void run(String in,String out) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        //指定jar包
        job.setJarByClass(StudentAbsence.class);
        //指定Mapper Reducer业务处理类
        job.setMapperClass(StudentAbsenceMapper.class);
        job.setReducerClass(StudentAbsenceReduce.class);
        //指定map输出类型
