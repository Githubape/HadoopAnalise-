...
public class PaylikeDriver {
    ...
    汇总数据
     */
    public static class PaylikeReduce extends Reducer<Text,IntWritable,Text,IntWritable>
    {
        @Override
    ...
    public void run() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setMapperClass(GradeLevelDriver.GradeLevelMapper.class);
        job.setReducerClass(GradeLevelDriver.GradeLevelReduce.class);
        //指定map输出类型
